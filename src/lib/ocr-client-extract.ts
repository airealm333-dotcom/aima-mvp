...
- document_date: the date printed on the document (issue date, statement date, receipt date). Use ISO format YYYY-MM-DD if possible, otherwise as printed. Use "Null" if not found.
